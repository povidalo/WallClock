package ru.povidalo.dashboard.openGL;
...
import ru.povidalo.dashboard.DashboardMax;
import ru.povidalo.dashboard.R;
import ru.povidalo.dashboard.openGL.TextureModifier.MandelbrotThread;
import ru.povidalo.dashboard.openGL.TextureModifier.ModifierThread;
import ru.povidalo.dashboard.openGL.TextureModifier.OnFrameReady;
...
public class CubeRenderer implements GLSurfaceView.Renderer {
	...
	public void onSurfaceChanged(GL10 glUnused, int width, int height) {
		...
		long mHz = DashboardMax.readCPUMaxFreq();
		int bmpSize;
		if (mHz > 0) {
